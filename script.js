...
const _slideEnam = function () {
  ...
  // Display the final image with we.jpg
  setTimeout(() => {
    if (finalImage) {
      finalImage.classList.remove('d-none');
    }
  }, 2000);
};
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "Barakallah fi umrik raisyaa, terima kasih sudah bertahan sampai sejauh ini. Tetaplah hidup", " ", "- Wish all you the best"],
  startDelay: 1000,
  speed: 75,
  waitUntilVisible: true
}).go();
